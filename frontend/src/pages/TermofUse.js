      ...
      <Container>
        ...
        <Row className="justify-content-center mx-3">
          <p className="coustard">
            This website is operated by Svadya. Throughout the site, the terms
            “we”, “us” and “our” refer to by Svadya. by Svadya  offers this
        ...
        <Row className="justify-content-center mx-3">
          <p className="coustard">
            ...
            shall Svadya, our directors, officers, employees, affiliates,
        ...
        <Row className="justify-content-center mx-3">
          <p className="coustard">
            You agree to indemnify, defend and hold harmless Svadya and our
        ...
        <Row className="justify-content-center mx-3">
          <p className="coustard">
            ...
            accordance with the laws of India and jurisdiction of Ahemdabad,
            Gujarat
          </p>
        </Row>
        <h5
